...
@section('content')
            ...
            <div class="row">
                ...
                <div class="col-xl-3 col-lg-3 col-md-12 col-sm-12 col-12">
                    <div class="card">
                        ...
                        <a href="#" class="btn btn-secondary mb-3 ml-3 mr-3" onclick="showUploadSpintaxCollectionsExcelDialog({{ $spintaxInput->id }}, '{{ "$spintaxInput->target" }}').apply(this, arguments)">Upload synonyms</a>
                    </div>
                </div>
                <!-- ============================================================== -->
                <!-- target details  -->
    ...
    @include('dialogs.spintax.upload-excel')
...
@section('js')
    ...
    @include('dialogs.spintax.upload-excel-js')
