    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="uplaodExcelModalLabel">Upload spintax collections</h5>
            ...
            >
                ...
                <div class="modal-footer">
                    <a href="/raws/spintax-template.xlsx" class="btn btn-secondary" download>Download template</a>
