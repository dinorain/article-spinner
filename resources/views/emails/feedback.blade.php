                    ...
                    <tr style="background-color: white !important;">
                        <td class="header"
                            ...
                            <a href="{{ config('app.url', '/') }}">
                                <img src="https://i.ibb.co/5xPYxyQ/ARCSPIN.png" alt="{{ config('app.name', 'ARCSPIN') }}" width="150">
                            </a>
                        </td>
                    </tr>
                                                                ...
                                                                <table border="0" cellpadding="0" cellspacing="0"
                                                                    ...
                                                                    <tr>
                                                                        <td
                                                                            style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box;">
                                                                            <p
                                                                                style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #74787E; font-size: 16px; line-height: 1.5em; margin-top: 0;">
                                                                                Thanks for your message. I sincerely appreciate your insight.<br><br>

If you have any more questions, comments, or concerns or compliments, please feel welcome to reach me out.
<br><br>
Best, <br> Dustin Jourdan <br>djourdan555@gmail.com</p>
                                ...
                                <tr>
                                    <td class="content-cell" align="center"
                                        ...
                                        <p
                                            ...
                                            © 2020 Dustin Jourdan. All rights reserved.</p>
                                    </td>
                                </tr>
                            </table>
                        </td>
